		...
		<section>
			<form name = "form" method = "post" action = "insert_memberProcess.jsp">
				...
				<div class = "password">
					...
					<label>비밀번호(최소 8자리 문자, 숫자 포함)</label>
				</div>
				<div class = "passcheck">
				...
				<div class = "birth">
					 <input type = "text" name = "birth" placeholder = "8자리 ex)20000218" maxlength = "8">
					 <label>생년월일</label>
				</div>
				<div class = "phone">
					...
					<input style = "width : 25%;" type = "text" name = "phone2" maxlength = "4"> - 
					<input style = "width : 25%;" type = "text" name = "phone3" maxlength = "4">
					<label>전화번호</label>
				</div>
				<div class = "address">
					<input type = "text" name = "address" placeholder = "예)경남 창원시 의창구 대원동">
					<label>주소</label>
				</div>
				<div class = "button">
